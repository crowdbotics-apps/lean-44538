"""
Django settings for lean_44538 project.
...
WSGI_APPLICATION = 'lean_44538.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "lean_44538 API",
    "DESCRIPTION": "API documentation for lean_44538 App",
    "VERSION": "v1",
}
